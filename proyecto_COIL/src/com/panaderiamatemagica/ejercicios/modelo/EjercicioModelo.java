...
public class EjercicioModelo {
    ...
    //constructor1
    public EjercicioModelo(String pregunta, int dificultad, int grado, String dimension, String pista, String tutorial, ArrayList<String> opcionesRespuestas, int numRespuesta,String descripcion) {
